    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <GridItem area="nav" zIndex={2}>
              <Flex
                direction={isLessThan600 ? 'row' : 'column'}
                alignItems="center"
                justifyContent={isLessThan600 ? 'space-between' : 'initial'}
                padding={isLessThan600 ? '1.5rem 1rem' : '3rem 1.7rem'}
                height="100%"
                bg={bg}
              >
                {!isLessThan600 && (
                ...
                {updateInfo}
                <TabList flexGrow={1} mb={isLessThan600 ? '0' : '2.4rem'}>
                  <Flex
                    direction={isLessThan600 ? 'row' : 'column'}
                    alignItems="center"
                    justifyContent="space-bewteen"
                    gap={isLessThan600 ? '1rem' : '2.4rem'}
                    flexGrow={1}
                  >
                    <Tab>
                      <svg
                    ...
                    <Menu isLazy lazyBehavior="unmount">
                      <MenuButton
                        as={Button}
                        variant="unstyled"
                        mt={!isLessThan600 ? 'auto' : '0'}
                        ms={isLessThan600 ? '1rem' : 'initial'}
                        order={isLessThan600 ? 5 : 'initial'}
                      >
                        {colorMode === 'dark' ? (
                  ...
                  {({ isOpen }) => (
                    <>
                      <MenuButton
                        ...
                        w="3.2rem"
                        h="3.2rem"
                        ms={isLessThan600 ? '1.7rem' : 'initial'}
                        _hover={{
                          transform: `scale(1.2)`,
                        }}
                      >
